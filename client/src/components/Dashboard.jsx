        ...
        <>
            <div className=" vh-100 p-0 w-100 bg-dark bg-gradient text-light">
                <div className="row bg-dark h-100 m-0 ">
                    <div className="col-sm-3 h-100 bg-dark bg-gradient">
                    ...
                    <div className="col-sm-9 bg-dark h-100 py-5 pt-0">
                        ...
                        <div className="row mt-5 message-container">
                            {
                                ...
                                <h2 className=" pb-2 ">Chat Messages Will Go Here</h2> 
                                : 
                        ...
                        <div className="row mt-1 p-3 message-box-container bg-gradient position-absolute bottom-0">
